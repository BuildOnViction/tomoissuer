...
export default {
    ...
    methods: {
        async getTokenDetail () {
            ...
            self.token = data
            self.token.address = (data.address || self.address).toLowerCase()
            self.token.contract = (data.address || self.address).toLowerCase()
            self.tokenName = data.name
            self.symbol = data.symbol
            self.contractCreation = (data.owner || self.account).toLowerCase()
